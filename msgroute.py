...
class MsgRoute(object):
    ...
    def undefine(self):
        return self.match('undefine')

    def text(self, *keywords):
        return self.match(TEXT, *keywords)

    def click(self, *keywords):
        return self.match(event['click'], *keywords)

    def location(self, *keywords):
        return self.match(LOCATION, *keywords)

    def subscribe(self, *keywords):
        return self.match(event['subscribe'], *keywords)

    def scan(self, *keywords):
        return self.match(event['scan'], *keywords)